      ...
      <Card title={isRegister ? '账户注册' : '账户登录'} className="login-card">
        <Form onFinish={onFinish} autoComplete="off">
          ...
          <Form.Item name="password" rules={[{ required: true }]}>
            <div>
              密码
              <Input.Password id="password" onChange={changePasswd} size="large" placeholder="请输入密码" />
            </div>
          </Form.Item>
          {isRegister && (
            <Form.Item
            ...
            >
              <div>
                确认密码
                <Input.Password id="confirm-password" onChange={changeConfirmPasswd} size="large" placeholder="请确认密码" />
              </div>
            </Form.Item>
          )}
